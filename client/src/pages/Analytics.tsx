...
export default function Analytics() {
  ...
  const getExerciseTypeLabel = (type: string) => {
    const exerciseTranslations: Record<string, Record<string, string>> = {
      ...
      daily_contextual: {
        ar: "اختبار مفردات قرآنية",
        en: "Quranic Vocabulary Quiz",
        id: "Kuis Kosakata Al-Quran",
        tr: "Kuran Kelime Sınavı",
        zh: "古兰经词汇测验",
        sw: "Jaribio la Msamiati wa Qur'an",
        so: "Imtixaanka Erayada Quraanka",
        bs: "Kviz Kur'anskog Vokabulara",
        sq: "Kuiz Fjalori Kur'anor",
        ru: "Словарный тест по Корану",
        ur: "قرآنی الفاظ کا امتحان",
        bn: "কোরআনিক শব্দভাণ্ডার কুইজ",
        ms: "Kuiz Perbendaharaan Kata Al-Quran",
      },
    };
