...
export default function Analytics() {
  ...
  const getExerciseTypeLabel = (type: string) => {
    const exerciseTranslations: Record<string, Record<string, string>> = {
      ...
      transformation: {
        ar: "مطابقة الحكمة الفلسفية",
        en: "Philosophical Match",
        id: "Kecocokan Filosofis",
        tr: "Felsefi Eşleştirme",
        zh: "哲学匹配",
        sw: "Kufananisha Falsafa",
        so: "Is-waafajinta Falsafadeed",
        bs: "Filozofsko podudaranje",
        sq: "Përputhje filozofike",
        ru: "Философское соответствие",
      },
      roleplay: {
