      ...
      <div className="w-full max-w-lg">
        ...
        <Card className="border-2 shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-bold">Join QuranSpeak</CardTitle>
            <CardDescription>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.memorizationLevel} onValueChange={(value) => handleInputChange("memorizationLevel", value)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="complete">Complete Quran (Hafiz)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.nativeLanguage} onValueChange={(value) => handleInputChange("nativeLanguage", value)}>
                  <SelectTrigger className="transition-all duration-200 focus:border-primary">
              ...
              <div className="space-y-2">
                ...
                <Select value={formData.learningGoal} onValueChange={(value) => handleInputChange("learningGoal", value)}>
                  ...
                  <SelectContent>
                    <SelectItem value="daily-conversation">Daily conversation in Arabic</SelectItem>
                    <SelectItem value="understand-quran">Better understand Quran</SelectItem>
                    <SelectItem value="islamic-studies">Islamic studies enhancement</SelectItem>
                    <SelectItem value="teaching">Teaching and dawah</SelectItem>
                    <SelectItem value="cultural-connection">Cultural connection</SelectItem>
                  </SelectContent>
                </Select>
              </div>
